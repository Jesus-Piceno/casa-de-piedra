...
export function LoginCard() {
  ...
  return (
    <div className="w-full max-w-md z-10">
      ...
      {/* Login Card */}
      <div className="bg-white dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-mosque/20 backdrop-blur-sm relative overflow-hidden">
        {/* Decorative elements */}
        ...
        {error && (
          <div className="mb-6 p-4 rounded-lg bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/50 text-sm">
            {error}
          </div>
        )}
        ...
        <div className="space-y-4 relative z-10">
          ...
          >
            ...
            {loadingProvider === "google" ? (
              <Loader2 className="w-5 h-5 animate-spin text-mosque dark:text-white relative z-10" />
            ) : (
          ...
          >
            ...
            <span className="relative z-10">{t("continueGithub")}</span>
          </button>
        </div>
